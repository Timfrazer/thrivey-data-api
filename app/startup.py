...
user_behaviour_df = pd.merge(
    user_df, behaviour_df, left_on="id", right_on="user_id"
...
ordered_user_behaviour_df.to_sql(
    "user_behaviour", conn, if_exists="replace", index=True
)
