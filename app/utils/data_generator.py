...
def add_n_more_dummy_rows(list_of_dicts: list, increase_rows: int, dt_format=default_datetime_format):
    ...
    for i in range(increase_rows):
        ...
        restructured_record = {
            ...
            "user": {
                ...
                "user_created": fake.date_time_ad(start_datetime='-5m', end_datetime='-4m').strftime(format=dt_format),
            ...
            "behaviour": {
                ...
                "date_created": fake.date_time_ad(start_datetime='-4m', end_datetime='-3m').strftime(format=dt_format),
